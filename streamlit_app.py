...
def page_q8_oil():
    ...
    ax1.plot(df["month"], df["total_sales"], color=color1, linewidth=2, label="Sales")
    ...
    ax2.plot(df["month"], df["avg_oil_price"], color=color2, linestyle='--', linewidth=2, label="Oil Price")
